                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Image.asset(
                              'assets/images/animation_lklgsngf_small.gif',
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'g49an4nq' /* Upload a photo for us to easil... */,
                        ),
                          ...
                          children: [
                            Align(
                              ...
                              child: FlutterFlowRadioButton(
                                ...
                                radioButtonColor: Color(0xFF8EDEEF),
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                await buttonLoginUsersRecord.reference
                                  ...
                                  userSex: _model.radioButtonValue1,
                                  photoUrl: _model.uploadedFileUrl,
                                  dob: _model.datePicked,
                                  profession: _model.radioButtonValue2,
                                  phoneNumber:
                                      _model.phoneNumberController.text,
                                  qualification: _model.radioButtonValue3,
                                ));

                                context.pushNamed('homePage');
                              },
                              text: FFLocalizations.of(context).getText(
                                'nfukjqqv' /* Complete Profile */,
                              ),
                              options: FFButtonOptions(
                                width: 230.0,
                                height: 50.0,

      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => OnboardingWidget(
            pp: params.getParam('pp', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'homePage',
        ...
        FFRoute(
          ...
          path: '/medicinePage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'medicinePage')
              : MedicinePageWidget(),
        ),
        FFRoute(
          name: 'profilePage',
        ...
        FFRoute(
          ...
          path: '/reminder',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'reminder')
              : ReminderWidget(),
        ),
        FFRoute(
          name: 'updateProfilePhoto',
          path: '/updateProfilePhoto',
          builder: (context, params) => UpdateProfilePhotoWidget(),
        ),
        FFRoute(
          name: 'team',
          path: '/team',
        ...
        FFRoute(
          name: 'References',
          path: '/references',
          builder: (context, params) => ReferencesWidget(),
        ),
        FFRoute(
          name: 'profile1',
          path: '/profile1',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Android_Large_-_1.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
